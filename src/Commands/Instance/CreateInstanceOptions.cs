...
namespace aggregator.cli.Commands.Instance
{
    ...
    {
        [Option('k', Description = "Azure AppPlan SKU hosting the Aggregator instances.")]
        public string HostingPlanSku { get; set; } = "Y1";

        [Option('t', Description = "Azure AppPlan Service tier hosting the Aggregator instances.")]
